...
# Hacemos un OFFSET de 300,000 para extraer exactamente los SIGUIENTES 200,000 registros
offset_value = 300000
limit_value = 200000
...
# PASO CLAVE: Vaciamos la tabla dataset_crudo para que SOLO contenga los 200k nuevos
